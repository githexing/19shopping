...
<body class="subBody">
    <form id="form1" runat="server" class="box_con">
        <div class="box_width">
            ...
            <div class="operation">
                <fieldset class="fieldset">
                    <div style="width: 74px; height: 20px; float: left; color: #fff; background: url('../../images/000.jpg'); text-align: center; line-height: 20px; font-weight: bold;">
                        未激活
                    </div>
                    <div style="width: 74px; height: 20px; float: left; color: #fff; background: url('../../images/001.jpg'); text-align: center; line-height: 20px; font-weight: bold;">
                        普通会员
                    </div>
                    <div style="width: 74px; height: 20px; float: left; color: #fff; background: url('../../images/002.jpg'); text-align: center; line-height: 20px; font-weight: bold;">
                        一星会员
                    </div>
                    <div style="width: 74px; height: 20px; float: left; color: #fff; background: url('../../images/003.jpg'); text-align: center; line-height: 20px; font-weight: bold;">
                        二星会员
                    </div>
                    <div style="width: 74px; height: 20px; float: left; color: #fff; background: url('../../images/004.jpg'); text-align: center; line-height: 20px; font-weight: bold;">
                        三星会员
                    </div>
                    <div style="width: 74px; height: 20px; float: left; color: #fff; background: url('../../images/005.jpg'); text-align: center; line-height: 20px; font-weight: bold;">
                        四星会员
                    </div>
                    <div style="width: 74px; height: 20px; float: left; color: #fff; background: url('../../images/006.jpg'); text-align: center; line-height: 20px; font-weight: bold;">
                        荣誉股东
                    </div>
