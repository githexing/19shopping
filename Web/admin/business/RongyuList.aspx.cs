...
{
    public partial class RongyuList  : AdminPageBase
    {
        ...
        private string getWhere2()
        {
            ...
            if (StarTime != "")
            {
                strWhere += string.Format(" and Convert(nvarchar(10),a.OpenTime,120)  >= '" + StarTime + "'");
            }
            if (EndTime != "")
            {
                strWhere += string.Format(" and  Convert(nvarchar(10),a.OpenTime,120)  <= '" + EndTime + "'");
            }
            return strWhere;
        }
        #endregion
        ...
        protected void Repeater2_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            TextBox Jine = (TextBox)e.Item.FindControl("Jine");//金额
            decimal jine = 0; 
            if (decimal.TryParse(Jine.Text,out jine))
            {
        ...
        private void MyExcel()
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    {
                        filename = dte.DataExcel(newTable, "已开通服务中心", FilePath, nameList);
                    }
                }
                catch
                {
