<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProduceType.aspx.cs" Inherits="web.admin.product.ProduceType" %>
        ...
        <form id="form1" class="main_dt" runat="server">
            ...
            <div class="operation">
                <fieldset class="fieldset">
                    一级分类：<asp:DropDownList ID="ddlPriduceType" runat="server">
                    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;二级分类：<asp:TextBox ID="txtPriduceType" runat="server"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;
