<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RongyuList.aspx.cs" Inherits="Web.admin.business.RongyuList" %>
                    ...
                    <form class="form-inline" action="#">
                        ...
                        <div class="mb15">
                            <div class="form-group">
                                ...
                                <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary mr5" iconcls="icon-search" style="display:none"
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table class="table table-bordered table-primary mb30">
                        <thead>
                            <tr>
                                <th style="min-width: 100px;">荣誉股东编号</th> 
                                <th style="min-width: 80px;">会员姓名</th>  
                                <th style="min-width: 80px;">输入发放金额</th> 
                        ...
                        <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_ItemCommand" OnItemDataBound="Repeater2_ItemDataBound">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                           <asp:TextBox ID="Jine" runat="server" ></asp:TextBox>
                                    </td>
