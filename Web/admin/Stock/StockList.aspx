<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockList.aspx.cs" Inherits="Web.admin.Stock.StockList" %>
        ...
        <div class="mainwrapper" style="top: 0px; background-color: #E8E8FF">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">已购列表查询</h4>
                </div>
                    ...
                    <table class="table table-bordered table-primary mb30">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 80px;">购进数量</th>
