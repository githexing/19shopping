<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBuyList.aspx.cs" Inherits="Web.admin.cash.CashBuyList" %>
                    ...
                    <table class="table table-bordered table-primary mb30">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 80px;">购买价格</th>
                                <th style="min-width: 80px;">购买总数</th>
                                <th style="min-width: 80px;">已购数量</th>
                        ...
                        <asp:Repeater runat="server" ID="Repeater1" OnItemCommand="Repeater1_ItemCommand" OnItemDataBound="Repeater1_ItemDataBound">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center">
                                        <asp:LinkButton ID="lbtnRemove" runat="server" CommandArgument='<%# Eval("CashbuyID") %>' class="btn btn-danger"
