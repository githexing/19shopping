<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProduceOneType.aspx.cs" Inherits="Web.admin.product.ProduceOneType" %>
    ...
    <div class="main_content">
        ...
        <div class="operation">
            <fieldset class="fieldset">
                一级分类：
                &nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtPriduceType" runat="server"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;
                ...
                <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater1_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <asp:TextBox runat="server" ID="txtTypeName" MaxLength="120" Style="text-align: center;
                                    width: 50%;" Text='<%# Eval("TypeName")%>'></asp:TextBox>
                            </td>
                            <td align="center">
                                <asp:LinkButton ID="LinkButton4" CommandArgument='<%#Eval("ID") %>' CommandName="Update" OnClientClick="return confirm('您确定要修改吗?')"
                                    runat="server">编辑</asp:LinkButton>
                                &nbsp;<%--<asp:LinkButton ID="LinkButton2" CommandArgument='<%#Eval("ID") %>' CommandName="del"
