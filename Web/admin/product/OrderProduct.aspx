            ...
            <div class="operation">
                ...
                <fieldset class="fieldset">
                    ...
                    <table width="99%" border="0" cellspacing="0" cellpadding="0" class="">
                        <tr>
                            <td>
                                会员编号：<input name="txtInput" id="txtInput" class="input_select" runat="server" type="text" />
                                服务中心编号：<input name="txtAgentCode" id="txtAgentCode" class="input_select" runat="server" type="text" />
                                收货方式：
                                <asp:DropDownList runat="server" ID="dropShType">
                                    <asp:ListItem Value="0">请选择</asp:ListItem>
                                    <asp:ListItem Value="1">所属服务中心自提</asp:ListItem>
                                    <asp:ListItem Value="2">公司发快递</asp:ListItem>
                                </asp:DropDownList>
                                结算日期：<asp:TextBox ID="txtStar" tip="输入结算日期" runat="server" onfocus="WdatePicker()" class="input_select"></asp:TextBox>
            ...
            <div class="dataTable">
                <table width="99%" border="0" cellspacing="0" cellpadding="0" class="t1">
                    <tr>
                        ...
                        <th align="center">物流单位
                        </th>
                        <th align="center">物流单号
                        </th>

                        <th align="center">支付类型
                        </th>
                        <th align="center">收货方式
                        </th>
                        <th align="center">服务中心
                        </th>
                        <th align="center">状态
                        </th>
                        <th align="center">操作
                    ...
                    <asp:Repeater ID="rptOrder" runat="server" OnItemCommand="rptOrder_ItemCommand" OnItemDataBound="Repeater1_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <%#Eval("UserAddr").ToString()=="1"?"所属服务中心自提":"公司发快递"%>
                                </td>
                                <td align="center">
                                    <%#Eval("AgentCode")%>
                                </td>
