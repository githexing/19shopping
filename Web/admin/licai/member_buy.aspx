<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_buy.aspx.cs" Inherits="Web.admin.licai.member_buy" %>
...
<body>
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" class="easyui-linkbutton"   
                ...
                <div class="operation">
                    ...
                    iconcls="icon-search" onclick="btnMairu_Click" > 搜 索 </asp:LinkButton>
                    </fieldset>
                </div>
        <div class="dataTable">
